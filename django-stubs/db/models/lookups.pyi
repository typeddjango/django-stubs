import sys
from typing import (
    Any, Generic, Iterable, List, Mapping, Optional, Tuple, Type, TypeVar, Union,
)
...
from django.db.models.sql.compiler import SQLCompiler, _ParamT, _ParamsT
...
class Lookup(Generic[_T]):
    ...
    def get_db_prep_lookup(
        self, value: _ParamT, connection: BaseDatabaseWrapper
    ) -> Tuple[str, _ParamsT]: ...
    def process_lhs(
