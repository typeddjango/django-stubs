...
def get_candidate_relations_to_delete(opts: Options) -> Iterable[Field[Any, Any]]: ...
...
class Collector:
    ...
    def can_fast_delete(self, objs: Model | Iterable[Model], from_field: Field[Any, Any] | None = ...) -> bool: ...
    def get_del_batches(
        self, objs: _IndexableCollection[Model], fields: Iterable[Field[Any, Any]]
