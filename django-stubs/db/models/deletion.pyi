...
class Collector:
    ...
    field_updates: defaultdict[tuple[Field[Any, Any], Any], list[Model]]
    ...
    def can_fast_delete(self, objs: Model | Iterable[Model], from_field: Field[Any, Any] | None = None) -> bool: ...
    def get_del_batches(
