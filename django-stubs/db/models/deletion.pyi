...
def get_candidate_relations_to_delete(opts: Options) -> Iterable[Field[Any, Any, Any]]: ...
...
class Collector:
    ...
    field_updates: defaultdict[tuple[Field[Any, Any, Any], Any], list[Model]]
    restricted_objects: defaultdict[Model, defaultdict[Field[Any, Any, Any], set[Model]]]
    ...
    def can_fast_delete(
        self, objs: Model | Iterable[Model], from_field: Field[Any, Any, Any] | None = None
    ) -> bool: ...
    def get_del_batches(
        self, objs: _IndexableCollection[Model], fields: Iterable[Field[Any, Any, Any]]
