...
class BaseExpression:
    ...
    def __init__(self, output_field: Field[Any, Any] | None = ...) -> None: ...
...
class CombinedExpression(SQLiteNumericMixin, Expression):
    ...
    rhs: Combinable
    def __init__(
        self, lhs: Combinable, connector: str, rhs: Combinable, output_field: Field[Any, Any] | None = ...
    ) -> None: ...
...
class Func(SQLiteNumericMixin, Expression):
    ...
    extra: dict[Any, Any]
    def __init__(self, *expressions: Any, output_field: Field[Any, Any] | None = ..., **extra: Any) -> None: ...
    def as_sql(
        self,
...
class Value(Expression):
    value: Any
    def __init__(self, value: Any, output_field: Field[Any, Any] | None = ...) -> None: ...

class RawSQL(Expression):
    params: list[Any]
    sql: str
    def __init__(self, sql: str, params: Sequence[Any], output_field: Field[Any, Any] | None = ...) -> None: ...
...
class Col(Expression):
    ...
    def __init__(self, alias: str, target: Field[Any, Any], output_field: Field[Any, Any] | None = ...) -> None: ...
...
class ExpressionWrapper(Expression):
    def __init__(self, expression: Q | Combinable, output_field: Field[Any, Any]) -> None: ...
...
class Case(Expression):
    ...
    extra: Any
    def __init__(
        self, *cases: Any, default: Any | None = ..., output_field: Field[Any, Any] | None = ..., **extra: Any
    ) -> None: ...
