...
class Combinable:
    ...
    def __neg__(self): ...
    def __add__(self, other: Union[float, timedelta, F, Aggregate]) -> CombinedExpression: ...
...
class BaseExpression:
    ...
    output_field: Any = ...
    def __init__(self, output_field: Optional[Union[str, ForeignObjectRel, Field]] = ...) -> None: ...
    ...
    def resolve_expression(self, query: Query = ..., allow_joins: bool = ..., reuse: Optional[Set[str]] = ..., summarize: bool = ..., for_save: bool = ...) -> Union[OrderBy, Expression]: ...
    def _prepare(self, field: Union[Field, DateTimeCheckMixin, reverse_related.OneToOneRel]) -> Expression: ...
    @property
    ...
    @staticmethod
    def _convert_value_noop(value: str, expression: BytesToCharFieldConversionMixin, connection: DatabaseWrapper) -> str: ...
    def convert_value(self) -> Callable: ...
    def get_lookup(self, lookup: str) -> object: ...
    def get_transform(self, name: str) -> Any: ...
    def relabeled_clone(self, change_map: Union[OrderedDict, Dict[Union[str, None], str]]) -> Expression: ...
    def copy(self) -> Union[OrderBy, Expression, SQLiteNumericMixin]: ...
    def get_group_by_cols(self) -> Union[List[CombinedExpression], List[Trunc], List[Col]]: ...
...
class CombinedExpression(SQLiteNumericMixin, Expression):
    ...
    lhs: Any = ...
    rhs: Any = ...
    def __init__(self, lhs: Combinable, connector: str, rhs: Union[F, Expression], output_field: None = ...) -> None: ...
    def __repr__(self): ...
    def __str__(self) -> str: ...
    def get_source_expressions(self) -> Any: ...
    def set_source_expressions(self, exprs: Any) -> None: ...
    def as_sql(self, compiler: SQLCompiler, connection: DatabaseWrapper) -> Union[Tuple[str, List[int]], Tuple[str, List[float]], Tuple[str, List[Any]], Tuple[str, List[datetime]]]: ...
    def resolve_expression(self, query: Query = ..., allow_joins: bool = ..., reuse: Optional[Set[str]] = ..., summarize: bool = ..., for_save: bool = ...) -> CombinedExpression: ...

class DurationExpression(CombinedExpression):
    def compile(self, side: Expression, compiler: SQLCompiler, connection: DatabaseWrapper) -> Union[Tuple[str, List[datetime]], Tuple[str, List[Any]]]: ...
...
class F(Combinable):
    ...
    def resolve_expression(self, query: Query = ..., allow_joins: bool = ..., reuse: Optional[Set[str]] = ..., summarize: bool = ..., for_save: bool = ...) -> Expression: ...
    def asc(self, **kwargs: Any) -> OrderBy: ...
    def desc(self, **kwargs: Any) -> OrderBy: ...
...
class OuterRef(F):
    def resolve_expression(self, query: Query = ..., allow_joins: bool = ..., reuse: None = ..., summarize: bool = ..., for_save: bool = ...) -> F: ...
...
class Func(SQLiteNumericMixin, Expression):
    ...
    def get_source_expressions(self) -> Any: ...
    def set_source_expressions(self, exprs: Any) -> None: ...
    def resolve_expression(self, query: Query = ..., allow_joins: bool = ..., reuse: None = ..., summarize: bool = ..., for_save: bool = ...) -> Func: ...
    def as_sql(self, compiler: SQLCompiler, connection: DatabaseWrapper, function: Optional[str] = ..., template: Optional[str] = ..., arg_joiner: Optional[str] = ..., **extra_context: Any) -> Any: ...
    def copy(self) -> Func: ...
...
class Col(Expression):
    ...
    def __init__(self, alias: str, target: Union[Field, DateTimeCheckMixin], output_field: Optional[Union[reverse_related.ForeignObjectRel, Field]] = ...) -> None: ...
    def __repr__(self) -> str: ...
    def as_sql(self, compiler: SQLCompiler, connection: DatabaseWrapper) -> Tuple[str, List[Any]]: ...
...
class ExpressionWrapper(Expression):
    expression: Any = ...
    def __init__(self, expression: Union[Q, CombinedExpression], output_field: Field) -> None: ...
    def set_source_expressions(self, exprs: Union[List[CombinedExpression], List[WhereNode]]) -> None: ...
    def get_source_expressions(self) -> Union[List[CombinedExpression], List[Q], List[WhereNode]]: ...
    def as_sql(self, compiler: SQLCompiler, connection: DatabaseWrapper) -> Union[Tuple[str, List[int]], Tuple[str, List[Any]]]: ...
    def __repr__(self) -> str: ...
...
class Case(Expression):
    ...
    def resolve_expression(self, query: Query = ..., allow_joins: bool = ..., reuse: None = ..., summarize: bool = ..., for_save: bool = ...) -> Case: ...
    def copy(self) -> Case: ...
    def as_sql(self, compiler: SQLCompiler, connection: DatabaseWrapper, template: None = ..., case_joiner: None = ..., **extra_context: Any) -> Any: ...
...
class Exists(Subquery):
    ...
    def as_sql(self, compiler: SQLCompiler, connection: DatabaseWrapper, template: None = ..., **extra_context: Any) -> Union[Tuple[str, Tuple], Tuple[str, Tuple[int]]]: ...
...
class OrderBy(BaseExpression):
    ...
    descending: Any = ...
    expression: Any = ...
    def __init__(self, expression: Union[F, Expression], descending: bool = ..., nulls_first: bool = ..., nulls_last: bool = ...) -> None: ...
    def __repr__(self) -> str: ...
    def set_source_expressions(self, exprs: Any) -> None: ...
    def get_source_expressions(self) -> Any: ...
    def as_sql(self, compiler: SQLCompiler, connection: DatabaseWrapper, template: Optional[str] = ..., **extra_context: Any) -> Union[Tuple[str, List[int]], Tuple[str, Tuple], Tuple[str, List[Any]]]: ...
