...
_OutputField = TypeVar("_OutputField", bound=Field[Any, Any, Any], default=Field[Any, Any, Any])
...
class BaseExpression:
    ...
    def __init__(self, output_field: Field[Any, Any, Any] | None = None) -> None: ...
    ...
    @property
    def field(self) -> Field[Any, Any, Any]: ...
    @cached_property
    def output_field(self) -> Field[Any, Any, Any]: ...
    @cached_property
    ...
    def get_source_fields(self) -> list[Field[Any, Any, Any] | None]: ...
...
def register_combinable_fields(
    lhs: type[Field[Any, Any, Any]],
    connector: str,
    rhs: type[Field[Any, Any, Any]],
    result: type[Field[Any, Any, Any]],
) -> None: ...
...
class CombinedExpression(SQLiteNumericMixin, Expression):
    ...
    rhs: Combinable
    def __init__(
        self, lhs: Combinable, connector: str, rhs: Combinable, output_field: Field[Any, Any, Any] | None = None
    ) -> None: ...
...
class Value(Expression):
    value: Any
    for_save: bool
    def __init__(self, value: Any, output_field: Field[Any, Any, Any] | None = None) -> None: ...
    @property
    @override
...
class RawSQL(Expression):
    params: list[Any]
    sql: str
    def __init__(self, sql: str, params: Sequence[Any], output_field: Field[Any, Any, Any] | None = None) -> None: ...

class Star(Expression): ...

class DatabaseDefault(Expression):
    def __init__(self, expression: Expression, output_field: Field[Any, Any, Any] | None = None) -> None: ...

class Col(Expression):
    target: Field[Any, Any, Any]
    alias: str
    contains_column_references: Literal[True]
    possibly_multivalued: Literal[False]
    def __init__(
        self, alias: str, target: Field[Any, Any, Any], output_field: Field[Any, Any, Any] | None = None
    ) -> None: ...
    @override
    def relabeled_clone(self, relabels: Mapping[str, str]) -> Self: ...
...
class ColPairs(Expression):
    alias: str
    targets: Sequence[Field[Any, Any, Any]]
    sources: Sequence[Field[Any, Any, Any]]
    def __init__(
        self,
        alias: str,
        targets: Sequence[Field[Any, Any, Any]],
        sources: Sequence[Field[Any, Any, Any]],
        output_field: Field[Any, Any, Any] | None,
    ) -> None: ...
...
class ExpressionList(Func):
    def __init__(
        self, *expressions: BaseExpression | Combinable, output_field: Field[Any, Any, Any] | None = None, **extra: Any
    ) -> None: ...
...
class ExpressionWrapper(Expression, Generic[_E]):
    ...
    @override
    def allowed_default(self) -> bool: ...  # type: ignore[override]
    def __init__(self, expression: _E, output_field: Field[Any, Any, Any]) -> None: ...
    expression: _E
...
class Case(Expression):
    ...
    extra: Any
    def __init__(
        self, *cases: Any, default: Any | None = None, output_field: Field[Any, Any, Any] | None = None, **extra: Any
    ) -> None: ...
    @override
    def as_sql(
        self,
...
class Window(SQLiteNumericMixin, Expression):
    ...
    def __init__(
        ...
        output_field: Field[Any, Any, Any] | None = None,
    ) -> None: ...
    @override
    def as_sql(
