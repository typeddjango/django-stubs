...
class BytesToCharFieldConversionMixin:
    def convert_value(self, value: str, expression: LPad, connection: DatabaseWrapper) -> str: ...
...
class Chr(Transform):
    ...
    def as_sqlite(self, compiler: SQLCompiler, connection: DatabaseWrapper, **extra_context: Any) -> Union[Tuple[str, List[int]], Tuple[str, List[Any]]]: ...
...
class Concat(Func):
    ...
    def _paired(self, expressions: Union[Tuple[Value, str, Value], Tuple[Value, str], Tuple[str, str]]) -> ConcatPair: ...
...
class LPad(BytesToCharFieldConversionMixin, Func):
    function: str = ...
    def __init__(self, expression: str, length: Union[int, Length], fill_text: Value = ..., **extra: Any) -> None: ...
...
class Ord(Transform):
    ...
    def as_sqlite(self, compiler: SQLCompiler, connection: DatabaseWrapper, **extra_context: Any) -> Union[Tuple[str, List[str]], Tuple[str, List[Any]]]: ...
...
class Replace(Func):
    function: str = ...
    def __init__(self, expression: F, text: Value, replacement: Value = ..., **extra: Any) -> None: ...
...
class Substr(Func):
    function: str = ...
    def __init__(self, expression: Union[str, Col], pos: Union[int, Value], length: Union[int, Value] = ..., **extra: Any) -> None: ...
    def as_sqlite(self, compiler: SQLCompiler, connection: DatabaseWrapper) -> Union[Tuple[str, List[int]], Tuple[str, List[Union[str, int]]]]: ...
