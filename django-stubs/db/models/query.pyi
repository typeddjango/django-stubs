...
class _QuerySet(Generic[_T, _Row], Collection[_Row], Reversible[_Row], Sized):
    ...
    def aget(self, *args: Any, **kwargs: Any) -> _Row: ...
    ...
    def abulk_update(self, objs: Iterable[_T], fields: Iterable[str], batch_size: Optional[int] = ...) -> int: ...
    ...
    def aearliest(self, *fields: Any, field_name: Optional[Any] = ...) -> _Row: ...
    def latest(self, *fields: Any, field_name: Optional[Any] = ...) -> _Row: ...
    def alatest(self, *fields: Any, field_name: Optional[Any] = ...) -> _Row: ...
    def first(self) -> Optional[_Row]: ...
    def afirst(self) -> Optional[_Row]: ...
    def last(self) -> Optional[_Row]: ...
    def alast(self) -> Optional[_Row]: ...
...
class RawQuerySet(Iterable[_T], Sized):
    ...
    def aiterator(self) -> Iterator[_T]: ...
    @property
