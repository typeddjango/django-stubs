...
class _QuerySet(Generic[_T, _Row], Collection[_Row], Reversible[_Row], Sized):
    ...
    async def aearliest(self, *fields: Any, field_name: Optional[Any] = ...) -> _Row: ...
    def latest(self, *fields: Any, field_name: Optional[Any] = ...) -> _Row: ...
    async def alatest(self, *fields: Any, field_name: Optional[Any] = ...) -> _Row: ...
    def first(self) -> Optional[_Row]: ...
    async def afirst(self) -> Optional[_Row]: ...
    def last(self) -> Optional[_Row]: ...
    async def alast(self) -> Optional[_Row]: ...
