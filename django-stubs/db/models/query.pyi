...
class BaseIterable:
    ...
    chunk_size: Any = ...
    def __init__(
        self, queryset: QuerySet, chunked_fetch: bool = ..., chunk_size: int = ...
    ) -> None: ...
...
class QuerySet:
    ...
    def datetimes(
        self, field_name: Any, kind: Any, order: str = ..., tzinfo: Optional[Any] = ...
    ): ...
    def none(self): ...
    def all(self): ...
...
class Prefetch:
    ...
    to_attr: Any = ...
    def __init__(
        self, lookup: str, queryset: Optional[QuerySet] = ..., to_attr: Optional[str] = ...
    ) -> None: ...
    ...
    def get_current_to_attr(
        self, level: int
    ) -> Union[Tuple[str, None], Tuple[str, bool]]: ...
