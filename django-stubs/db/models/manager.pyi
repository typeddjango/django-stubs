...
from django.db.models.query import Prefetch, QuerySet, RawQuerySet, _PrefetchedQuerySetT, _ToAttrT
...
class Manager(BaseManager[_T]):
    ...
    @overload
    def select_related(self) -> QuerySet[_T]: ...
    @overload
    def select_related(self, clear: None, /) -> QuerySet[_T]: ...
    @overload
    def select_related(self, *fields: str) -> QuerySet[_T]: ...
    @overload
    def prefetch_related(self) -> QuerySet[_T]: ...
    @overload
    def prefetch_related(self, clear: None, /) -> QuerySet[_T]: ...
    @overload
    def prefetch_related(self, *lookups: str | Prefetch[_PrefetchedQuerySetT, _ToAttrT]) -> QuerySet[_T]: ...
