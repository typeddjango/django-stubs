...
class ForwardManyToOneDescriptor(Generic[_F]):
    ...
    def get_queryset(self, *, instance: Model) -> QuerySet[Any]: ...
...
class ReverseOneToOneDescriptor(Generic[_From, _To]):
    ...
    def get_queryset(self, *, instance: Model) -> QuerySet[_To]: ...
    def get_prefetch_querysets(
    ...
    # For compatibility with the fetcher protocol. While `self.related` is really a `OneToOneRel`,
    # it quacks enough like a `Field` to work.
    @property
