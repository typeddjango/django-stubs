...
class ReverseOneToOneDescriptor(Generic[_From, _To]):
    ...
    @overload
    def __get__(self, instance: None, cls: Any = None) -> ReverseOneToOneDescriptor[_From, _To]: ...
    @overload
    def __get__(self, instance: _From, cls: Any = None) -> _To: ...
...
class ReverseManyToOneDescriptor(Generic[_To]):
    ...
    @overload
    def __get__(self, instance: None, cls: Any = None) -> Self: ...
    @overload
    def __get__(self, instance: Model, cls: Any = None) -> RelatedManager[_To]: ...
...
class ManyToManyDescriptor(ReverseManyToOneDescriptor, Generic[_To, _Through]):
    ...
    def __get__(self, instance: None, cls: Any = None) -> Self: ...
    @overload
    def __get__(self, instance: Model, cls: Any = None) -> ManyRelatedManager[_To, _Through]: ...
