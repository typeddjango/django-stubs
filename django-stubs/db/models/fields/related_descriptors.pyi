...
class ManyRelatedManager(Manager[_M], Generic[_M]):
    related_val: tuple[int, ...]
    def add(self, *objs: _M | int, bulk: bool = ..., through_defaults: dict[str, Any] | None = None) -> None: ...
    async def aadd(self, *objs: _M | int, bulk: bool = ..., through_defaults: dict[str, Any] | None = None) -> None: ...
    def remove(self, *objs: _M | int, bulk: bool = ...) -> None: ...
    async def aremove(self, *objs: _M | int, bulk: bool = ...) -> None: ...
    def set(
        self,
