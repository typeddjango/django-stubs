...
class ForeignObjectRel(FieldCacheMixin):
    ...
    @property
    def target_field(self) -> Field[Any, Any, Any]: ...
    @cached_property
    ...
    def get_joining_fields(self) -> tuple[tuple[Field[Any, Any, Any], Field[Any, Any, Any]], ...]: ...
...
class ManyToOneRel(ForeignObjectRel):
    ...
    def get_related_field(self) -> Field[Any, Any, Any]: ...
    @override
