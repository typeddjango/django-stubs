...
from typing import (
    Any, Callable, Dict, Iterable, Iterator, List, Optional, Set,
...
from django.db.models.sql.subqueries import (
    InsertQuery, DeleteQuery, UpdateQuery, AggregateQuery
)
...
class SQLCompiler:
    ...
    ordering_parts: Any = ...
    def __init__(
        self, query: Query, connection: BaseDatabaseWrapper, using: Optional[str]
    ) -> None: ...
    ...
    def get_select(
        ...
        List[Tuple[Expression, _AsSqlType, Optional[str]]],
...
def cursor_iter(cursor: CursorWrapper, sentinel: Any, col_count: Optional[int], itersize: int) -> Iterator[List[Sequence[Any]]]: ...
