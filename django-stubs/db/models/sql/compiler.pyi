...
class SQLCompiler:
    ...
    def composite_fields_to_tuples(self, rows: Iterable[Any], expressions: Iterable[Any]) -> Iterator[Any]: ...
    def has_composite_fields(self, expressions: Iterable[Any]) -> bool: ...

class SQLInsertCompiler(SQLCompiler):
    query: InsertQuery
    returning_fields: Sequence[Any] | None
    returning_params: Sequence[Any]
    def field_as_sql(self, field: Any, get_placeholder: Callable, val: Any) -> _AsSqlType: ...
