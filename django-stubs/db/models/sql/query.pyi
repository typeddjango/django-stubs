...
class Query(BaseExpression):
    ...
    def trim_joins(
        self, targets: tuple[Field[Any, Any, Any], ...], joins: list[str], path: list[PathInfo]
    ) -> tuple[tuple[Field[Any, Any, Any], ...], str, list[str]]: ...
    def resolve_ref(
    ...
    def is_nullable(self, field: Field[Any, Any, Any]) -> bool: ...
