...
class RawQuery:
    ...
    @property
    def params_type(self) -> None | type[dict[Any, Any]] | type[tuple[Any, ...]]: ...
...
class Query(BaseExpression):
    ...
    def get_meta(self) -> Options[Model]: ...
    ...
    def deferred_to_data(self, target: dict[Any, Any], callback: Callable[..., Any]) -> None: ...
    ...
    def get_loaded_field_names_cb(
        self, target: dict[type[Model], set[str]], model: type[Model], fields: set[Field[Any, Any]]
    ) -> None: ...
    ...
    def build_lookup(self, lookups: Sequence[str], lhs: Expression | Query, rhs: Any) -> Lookup[Any]: ...
