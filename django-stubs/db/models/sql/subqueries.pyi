...
class UpdateQuery(Query):
    ...
    def add_update_fields(self, values_seq: list[tuple[Field[Any, Any], type[Model] | None, Case]]) -> None: ...
    def add_related_update(self, model: type[Model], field: Field[Any, Any], value: int | str) -> None: ...
