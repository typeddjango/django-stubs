...
class UpdateQuery(Query):
    ...
    def add_update_fields(self, values_seq: list[tuple[Field[Any, Any, Any], type[Model] | None, Case]]) -> None: ...
    def add_related_update(self, model: type[Model], field: Field[Any, Any, Any], value: int | str) -> None: ...
    def get_related_updates(self) -> list[UpdateQuery]: ...

class InsertQuery(Query):
    fields: Iterable[Field[Any, Any, Any]]
    objs: list[Model]
    raw: bool
    def __init__(
        self,
    ...
    def insert_values(self, fields: Iterable[Field[Any, Any, Any]], objs: list[Model], raw: bool = False) -> None: ...
