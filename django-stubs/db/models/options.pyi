...
class Options(Generic[_M]):
    ...
    local_managers: list[Manager[Model]]
    ...
    def add_manager(self, manager: Manager[Model]) -> None: ...
    ...
    @property
    def managers(self) -> ImmutableList[Manager[Model]]: ...
    @property
    def managers_map(self) -> dict[str, Manager[Model]]: ...
    @property
    def base_manager(self) -> Manager[Model]: ...
    @property
    def default_manager(self) -> Manager[Model] | None: ...
    @property
