...
class BaseDatabaseCreation:
    ...
    def _execute_create_test_db(self, cursor: Any, parameters: Any, keepdb: bool = ...) -> None: ...
    ...
    def destroy_test_db(self, old_database_name: str = ..., verbosity: int = ..., keepdb: bool = ..., suffix: None = ...) -> None: ...
