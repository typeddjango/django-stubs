...
class BaseDatabaseOperations:
    ...
    connection: Any = ...
    _cache: Any = ...
    def __init__(self, connection: Union[DefaultConnectionProxy, backends.base.base.BaseDatabaseWrapper]) -> None: ...
    ...
    def datetime_trunc_sql(self, lookup_type: None, field_name: None, tzname: None) -> None: ...
    ...
    def sequence_reset_sql(self, style: Style, model_list: Union[Set[Type[Model]], List[Type[Model]], Set[Type[Union[Group, User]]], List[Type[Site]]]) -> List[Any]: ...
    ...
    def adapt_decimalfield_value(self, value: Optional[Decimal], max_digits: Optional[int] = ..., decimal_places: Optional[int] = ...) -> Optional[str]: ...
    ...
    def convert_durationfield_value(self, value: Optional[float], expression: Expression, connection: DatabaseWrapper) -> Optional[timedelta]: ...
