...
class BaseDatabaseOperations:
    ...
    def unification_cast_sql(self, output_field: Field[Any, Any, Any]) -> str: ...
    ...
    def bulk_insert_sql(self, fields: Iterable[Field[Any, Any, Any]], placeholder_rows: Iterable[str]) -> str: ...
    ...
    def returning_columns(self, fields: Iterable[Field[Any, Any, Any]]) -> tuple[str, tuple[()]]: ...
    ...
    def prepare_join_on_clause(
        self, lhs_table: str, lhs_field: Field[Any, Any, Any], rhs_table: str, rhs_field: Field[Any, Any, Any]
    ) -> tuple[Col, Col]: ...
