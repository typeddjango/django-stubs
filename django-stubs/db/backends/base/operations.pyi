...
class BaseDatabaseOperations:
    ...
    def bulk_insert_sql(self, fields: Iterable[Field[Any, Any]], placeholder_rows: Iterable[str]) -> str: ...
    ...
    def returning_columns(self, fields: Iterable[Field[Any, Any]]) -> tuple[str, tuple[()]]: ...
    def fetch_returned_rows(self, cursor: CursorWrapper, returning_params: tuple[()]) -> list[tuple[Any, ...]]: ...
    ...
    def adapt_durationfield_value(self, value: timedelta | None) -> int | None: ...
    ...
    def convert_trunc_expression(
        self, value: real_datetime | None, expression: Expression
    ) -> real_datetime | date | time | None: ...
    ...
    def binary_placeholder_sql(self, value: Case | None, compiler: SQLCompiler) -> str: ...
    ...
    def prepare_join_on_clause(
        self, lhs_table: str, lhs_field: Field[Any, Any], rhs_table: str, rhs_field: Field[Any, Any]
    ) -> tuple[Col, Col]: ...
    def format_debug_sql(self, sql: str) -> str: ...
    def format_json_path_numeric_index(self, num: int) -> str: ...
    def compile_json_path(self, key_transforms: Iterable[str], include_root: bool = True) -> str: ...
