...
class BaseDatabaseSchemaEditor:
    ...
    def _delete_composed_index(self, model: Type[Model], fields: Tuple[str, str], constraint_kwargs: Dict[str, bool], sql: str) -> None: ...
    ...
    def _alter_field(self, model: Any, old_field: Any, new_field: Any, old_type: Any, new_type: Any, old_db_params: Any, new_db_params: Any, strict: bool = ...) -> None: ...
    def _alter_column_null_sql(self, model: Any, old_field: Any, new_field: Any): ...
    def _alter_column_default_sql(self, model: Any, old_field: Any, new_field: Any, drop: bool = ...): ...
    def _alter_column_type_sql(self, model: Any, old_field: Any, new_field: Any, new_type: Any): ...
    def _alter_many_to_many(self, model: Any, old_field: Any, new_field: Any, strict: Any) -> None: ...
    def _create_index_name(self, table_name: str, column_names: Union[Tuple[str, str, str], List[str], Tuple[str]], suffix: str = ...) -> str: ...
    def _get_index_tablespace_sql(self, model: Any, fields: Any, db_tablespace: Optional[Any] = ...): ...
    def _create_index_sql(self, model: Type[Model], fields: Any, *, name: Optional[Any] = ..., suffix: str = ..., using: str = ..., db_tablespace: Optional[Any] = ..., col_suffixes: Any = ..., sql: Optional[Any] = ...) -> Statement: ...
    ...
    def _rename_field_sql(self, table: Any, old_field: Any, new_field: Any, new_type: Any): ...
    ...
    def _constraint_names(self, model: Type[Model], column_names: List[str] = ..., unique: Optional[bool] = ..., primary_key: None = ..., index: Optional[bool] = ..., foreign_key: None = ..., check: None = ..., type_: None = ...) -> List[str]: ...
