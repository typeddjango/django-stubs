...
class BaseDatabaseSchemaEditor(AbstractContextManager[Any]):
    ...
    def skip_default_on_alter(self, field: Field[Any, Any, Any]) -> bool: ...
    def prepare_default(self, value: Any) -> Any: ...
    def db_default_sql(self, field: Field[Any, Any, Any]) -> _AsSqlType: ...
    def effective_default(self, field: Field[Any, Any, Any]) -> int | str: ...
    ...
    def alter_field(
        self, model: type[Model], old_field: Field[Any, Any, Any], new_field: Field[Any, Any, Any], strict: bool = False
    ) -> None: ...
