...
class Columns(TableColumns):
    quote_name: Any = ...
    col_suffixes: Any = ...
    def __init__(self, table: str, columns: List[str], quote_name: Callable, col_suffixes: Union[List[str], Tuple] = ...) -> None: ...
    def __str__(self) -> str: ...
...
class ForeignKeyName(TableColumns):
    ...
    suffix_template: Any = ...
    create_fk_name: Any = ...
    def __init__(self, from_table: str, from_columns: List[str], to_table: str, to_columns: List[str], suffix_template: str, create_fk_name: Callable) -> None: ...
    def references_table(self, table: str) -> bool: ...
    def references_column(self, table: str, column: str) -> bool: ...
    def rename_table_references(self, old_table: Any, new_table: Any) -> None: ...
    def rename_column_references(self, table: str, old_column: str, new_column: str) -> None: ...
