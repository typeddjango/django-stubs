...
class DatabaseOperations(BaseDatabaseOperations):
    ...
    def last_executed_query(self, cursor: Union[SQLiteCursorWrapper, CursorDebugWrapper], sql: str, params: Optional[Union[List[str], Tuple]]) -> str: ...
    def quote_name(self, name: str) -> str: ...
    def no_limit_value(self) -> int: ...
    def sql_flush(self, style: Style, tables: List[str], sequences: Union[List[Dict[str, str]], Tuple], allow_cascade: bool = ...) -> List[str]: ...
    def execute_sql_flush(self, using: str, sql_list: List[str]) -> None: ...
    def adapt_datetimefield_value(self, value: Optional[Union[datetime, F]]) -> Optional[Union[str, F]]: ...
    ...
    def convert_datetimefield_value(self, value: Optional[Union[str, datetime]], expression: Expression, connection: DatabaseWrapper) -> Optional[datetime]: ...
    def convert_datefield_value(self, value: Optional[Union[str, date]], expression: Union[Col, Cast, Aggregate, django.db.models.functions.TruncBase], connection: DatabaseWrapper) -> Optional[date]: ...
    def convert_timefield_value(self, value: Optional[Union[str, time]], expression: Union[Col, Max, django.db.models.functions.TruncBase], connection: DatabaseWrapper) -> Optional[time]: ...
    def get_decimalfield_converter(self, expression: Union[Col, CombinedExpression, Aggregate]) -> Callable: ...
    def convert_uuidfield_value(self, value: Optional[str], expression: Col, connection: DatabaseWrapper) -> Optional[UUID]: ...
    def convert_booleanfield_value(self, value: Optional[int], expression: Expression, connection: DatabaseWrapper) -> Optional[bool]: ...
    ...
    def subtract_temporals(self, internal_type: str, lhs: Tuple[str, List[Any]], rhs: Union[Tuple[str, List[str]], Tuple[str, List[Any]]]) -> Union[Tuple[str, List[str]], Tuple[str, List[Any]]]: ...
