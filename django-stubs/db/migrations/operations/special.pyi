...
class SeparateDatabaseAndState(Operation):
    ...
    def __init__(self, database_operations: List[ModelOperation] = ..., state_operations: Union[List[CreateModel], List[AddField], List[ModelOperation]] = ...) -> None: ...
...
class RunSQL(Operation):
    ...
    def describe(self): ...
    def _run_sql(self, schema_editor: DatabaseSchemaEditor, sqls: Union[str, List[str]]) -> None: ...
...
class RunPython(Operation):
    ...
    hints: Any = ...
    elidable: Any = ...
    def __init__(self, code: Union[str, Callable], reverse_code: Optional[Callable] = ..., atomic: None = ..., hints: Optional[Dict[str, str]] = ..., elidable: bool = ...) -> None: ...
    def deconstruct(self): ...
    @property
