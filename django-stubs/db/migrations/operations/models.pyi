...
class AlterTogetherOptionOperation(ModelOptionOperation):
    ...
    def __init__(
        self,
        name: str,
        option_value: _OptionTogetherT,
    ) -> None: ...
    @property
    def option_value(self) -> Set[Tuple[str, ...]]: ...
...
class AlterUniqueTogether(AlterTogetherOptionOperation):
    option_name: str = ...
    unique_together: Set[Tuple[str, ...]] = ...
    def __init__(self, name: str, unique_together: _OptionTogetherT) -> None: ...

class AlterIndexTogether(AlterTogetherOptionOperation):
    option_name: str = ...
    index_together: Set[Tuple[str, ...]] = ...
    def __init__(self, name: str, index_together: _OptionTogetherT) -> None: ...
