...
class ModelOperation(Operation):
    ...
    def reduce(self, operation: Union[FieldOperation, ModelOperation], in_between: Any, app_label: Optional[str] = ...) -> bool: ...
...
class CreateModel(ModelOperation):
    ...
    bases: Any = ...
    managers: Any = ...
    def __init__(self, name: str, fields: Any, options: Any = ..., bases: Any = ..., managers: Any = ...) -> None: ...
...
class AlterModelTable(ModelOperation):
    ...
    def describe(self) -> str: ...
    def reduce(self, operation: DeleteModel, in_between: List[Any], app_label: None = ...) -> List[DeleteModel]: ...

class ModelOptionOperation(ModelOperation):
    def reduce(self, operation: Union[FieldOperation, CreateModel, FieldRelatedOptionOperation], in_between: List[DeleteModel], app_label: Optional[str] = ...) -> Union[bool, List[AlterUniqueTogether]]: ...

class FieldRelatedOptionOperation(ModelOptionOperation):
    def reduce(self, operation: Union[FieldOperation, CreateModel, AlterIndexTogether], in_between: List[DeleteModel], app_label: Optional[str] = ...) -> Any: ...

class AlterUniqueTogether(FieldRelatedOptionOperation):
    option_name: str = ...
    unique_together: Any = ...
    def __init__(self, name: str, unique_together: Optional[Union[List[List[str]], Set[Tuple[str, str]], List[Tuple[str, str]]]]) -> None: ...
...
class AlterIndexTogether(FieldRelatedOptionOperation):
    option_name: str = ...
    index_together: Any = ...
    def __init__(self, name: str, index_together: Optional[Union[List[List[str]], List[Tuple[str, str]], Set[Tuple[str, str]]]]) -> None: ...
    def deconstruct(self) -> Tuple[str, List[Any], Dict[str, Union[str, Set[Tuple[str, str]]]]]: ...
