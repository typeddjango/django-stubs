...
class FieldOperation(Operation):
    model_name: str
    name: str
    def __init__(self, model_name: str, name: str, field: Field[Any, Any, Any] | None = None) -> None: ...
    @cached_property
...
class AddField(FieldOperation):
    ...
    def __init__(
        self, model_name: str, name: str, field: Field[Any, Any, Any], preserve_default: bool = True
    ) -> None: ...
