...
class FieldOperation(Operation):
    model_name: str
    name: str
    def __init__(self, model_name: str, name: str, field: Field[Any, Any] | None = ...) -> None: ...
    @property
...
class AddField(FieldOperation):
    ...
    def __init__(self, model_name: str, name: str, field: Field[Any, Any], preserve_default: bool = ...) -> None: ...
