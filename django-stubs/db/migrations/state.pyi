...
class ModelState:
    ...
    def __init__(
        ...
        app_label: str,
        name: str,
        fields: list[tuple[str, Field[Any, Any, Any]]] | dict[str, Field[Any, Any, Any]],
    ...
    def get_field(self, field_name: str) -> Field[Any, Any, Any]: ...
    @cached_property
...
class ProjectState:
    ...
    def alter_constraint(self, app_label: str, model_name: str, constraint_name: str, constraint: Any) -> None: ...
    def add_field(
        self, app_label: str, model_name: str, name: str, field: Field[Any, Any, Any], preserve_default: Any
    ) -> None: ...
    ...
    def resolve_model_field_relations(
        self, model_key: tuple[str, str], field_name: str, field: Field[Any, Any, Any], concretes: Any | None = None
    ) -> None: ...
