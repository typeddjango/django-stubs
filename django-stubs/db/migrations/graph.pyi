...
class MigrationGraph:
    ...
    def add_dependency(self, migration: Optional[Union[Migration, str]], child: Tuple[str, str], parent: Tuple[str, str], skip_validation: bool = ...) -> None: ...
    ...
    def ensure_not_cyclic(self, start: Union[Node, Tuple[str, str]], get_children: Callable) -> None: ...
    ...
    def make_state(self, nodes: Optional[Tuple[str, str]] = ..., at_end: bool = ..., real_apps: List[str] = ...) -> ProjectState: ...
