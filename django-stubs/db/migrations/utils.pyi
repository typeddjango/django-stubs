...
def field_references(
    ...
    reference_field: Field[Any, Any, Any] | None = None,
) -> Literal[False] | FieldReference: ...
def get_references(
    state: ProjectState,
    model_tuple: tuple[str, str],
    field_tuple: tuple[()] | tuple[str, Field[Any, Any, Any]] = (),
) -> Iterator[tuple[ModelState, str, Field[Any, Any, Any], FieldReference]]: ...
def field_is_referenced(
    state: ProjectState, model_tuple: tuple[str, str], field_tuple: tuple[str, Field[Any, Any, Any]]
) -> bool: ...
