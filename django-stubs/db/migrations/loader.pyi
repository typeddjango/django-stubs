...
class MigrationLoader:
    ...
    graph: Any
    replacements: dict[tuple[str, str], Migration]
    replacements_progress: dict[tuple[str, str], bool]
    def build_graph(self) -> None: ...
    def replace_migration(self, migration_key: tuple[str, str]) -> None: ...
    def all_replaced_applied(
        self, migration_key: tuple[str, str], applied: dict[tuple[str, str], Migration]
    ) -> bool: ...
