...
class Media:
    ...
    def render_css(self) -> Iterable[str]: ...
...
class ChoiceWidget(Widget):
    ...
    def optgroups(self, name: str, value: List[str], attrs: Optional[_OptAttrs] = ...) -> List[Tuple[Optional[str], List[Dict[str, Any]], Optional[int]]]: ...
    def get_context(self, name: str, value: Any, attrs: Optional[_OptAttrs]) -> Dict[str, Any]: ...
    def create_option(
        self,
        name: str,
...
class MultiWidget(Widget):
    ...
    def __init__(self, widgets: Union[Dict[str, Union[Widget, Type[Widget]]], Sequence[Union[Widget, Type[Widget]]]], attrs: Optional[_OptAttrs] = ...) -> None: ...
    @property
    def is_hidden(self) -> bool: ...
    def get_context(self, name: str, value: Any, attrs: Optional[_OptAttrs]) -> Dict[str, Any]: ...
    def id_for_label(self, id_: str) -> str: ...
