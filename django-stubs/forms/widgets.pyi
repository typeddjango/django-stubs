...
class Media:
    def __init__(
        self,
        media: type | None = ...,
        css: dict[str, Sequence[str]] | None = ...,
        js: Sequence[str] | None = ...,
    ) -> None: ...
...
class Widget(metaclass=MediaDefiningClass):
    ...
    def render(
        self, name: str, value: Any, attrs: _OptAttrs | None = ..., renderer: BaseRenderer | None = ...
    ) -> SafeString: ...
    def build_attrs(self, base_attrs: _OptAttrs, extra_attrs: _OptAttrs | None = ...) -> dict[str, Any]: ...
    def value_from_datadict(self, data: _DataT, files: _FilesT[AnyStr], name: str) -> Any: ...
    def value_omitted_from_data(self, data: _DataT, files: _FilesT[AnyStr], name: str) -> bool: ...
...
class ClearableFileInput(FileInput):
    ...
    def is_initial(self, value: File[AnyStr] | str | None) -> bool: ...
    def get_context(self, name: str, value: Any, attrs: _OptAttrs | None) -> dict[str, Any]: ...
    def value_from_datadict(self, data: _DataT, files: _FilesT[AnyStr], name: str) -> Any: ...
    def value_omitted_from_data(self, data: _DataT, files: _FilesT[AnyStr], name: str) -> bool: ...
...
class NullBooleanSelect(Select):
    ...
    def value_from_datadict(self, data: _DataT, files: _FilesT[AnyStr], name: str) -> bool | None: ...
...
class CheckboxSelectMultiple(ChoiceWidget):
    ...
    def use_required_attribute(self, initial: Any) -> bool: ...
    def value_omitted_from_data(self, data: _DataT, files: _FilesT[AnyStr], name: str) -> bool: ...
    def id_for_label(self, id_: str, index: str | None = ...) -> str: ...
...
class MultiWidget(Widget):
    ...
    def get_context(self, name: str, value: Any, attrs: _OptAttrs | None) -> dict[str, Any]: ...
    def id_for_label(self, id_: str) -> str: ...
    def value_from_datadict(self, data: _DataT, files: _FilesT[AnyStr], name: str) -> list[Any]: ...
    def value_omitted_from_data(self, data: _DataT, files: _FilesT[AnyStr], name: str) -> bool: ...
...
class SelectDateWidget(Widget):
    ...
    def __init__(
        ...
        months: Mapping[int, str] | None = ...,
        empty_label: str | _ListOrTuple[str] | None = ...,
    ) -> None: ...
    def get_context(self, name: str, value: Any, attrs: _OptAttrs | None) -> dict[str, Any]: ...
    def format_value(self, value: Any) -> dict[str, str | int | None]: ...  # type: ignore
    def id_for_label(self, id_: str) -> str: ...
    def value_from_datadict(self, data: _DataT, files: _FilesT[AnyStr], name: str) -> str | None | Any: ...
    def value_omitted_from_data(self, data: _DataT, files: _FilesT[AnyStr], name: str) -> bool: ...
