...
class BaseForm(RenderableFormMixin):
    ...
    @overload
    def add_error(self, field: None, error: dict[str, list[ValidationError | _StrOrPromise]]) -> None: ...
    @overload
    def add_error(self, field: str | None, error: ValidationError | _StrOrPromise | list[ValidationError | _StrOrPromise]) -> None: ...
