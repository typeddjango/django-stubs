...
from django.core.paginator import Paginator, Page, _SupportsPagination
...
class MultipleObjectMixin(Generic[_M], ContextMixin):
    ...
    def paginate_queryset(self, queryset: _SupportsPagination[_M], page_size: int) -> Tuple[Paginator, Page, _SupportsPagination[_M], bool]: ...
    def get_paginate_by(self, queryset: _SupportsPagination[_M]) -> Optional[int]: ...
    def get_paginator(
        self, queryset: _SupportsPagination[_M], per_page: int, orphans: int = ..., allow_empty_first_page: bool = ..., **kwargs: Any
    ) -> Paginator: ...
