...
class BaseDateListView(MultipleObjectMixin[_M], DateMixin, View):
    ...
    def get_dated_items(self) -> _DatedItems[Any]: ...
    @override
    ...
    def get_date_list(
        self, queryset: models.query.QuerySet[Any], date_type: str | None = ..., ordering: str = ...
...
class ArchiveIndexView(MultipleObjectTemplateResponseMixin, BaseArchiveIndexView[Any]):
...
class YearArchiveView(MultipleObjectTemplateResponseMixin, BaseYearArchiveView[Any]):
    template_name_suffix: str
...
class MonthArchiveView(MultipleObjectTemplateResponseMixin, BaseMonthArchiveView[Any]):
    template_name_suffix: str
...
class WeekArchiveView(MultipleObjectTemplateResponseMixin, BaseWeekArchiveView[Any]):
    template_name_suffix: str
...
class DayArchiveView(MultipleObjectTemplateResponseMixin, BaseDayArchiveView[Any]):
    template_name_suffix: str
...
class TodayArchiveView(MultipleObjectTemplateResponseMixin, BaseTodayArchiveView[Any]):
    template_name_suffix: str
...
class DateDetailView(SingleObjectTemplateResponseMixin, BaseDateDetailView[Any]):
    template_name_suffix: str
