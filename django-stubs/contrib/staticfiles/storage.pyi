...
_PostProcessT = Iterator[
    Union[Tuple[str, str, bool], Tuple[str, None, RuntimeError]]
]

class StaticFilesStorage(FileSystemStorage):
    base_location: str
    location: _PathCompatible
    def __init__(self, location: Optional[_PathCompatible] = ..., base_url: Optional[str] = ..., *args: Any, **kwargs: Any) -> None: ...
...
class HashedFilesMixin:
    ...
    def post_process(
        self, paths: Dict[str, Any], dry_run: bool = ..., **options: Any
    ) -> _PostProcessT: ...
