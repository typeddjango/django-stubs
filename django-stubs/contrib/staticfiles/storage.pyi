...
class HashedFilesMixin:
    ...
    def file_hash(self, name: str, content: File[AnyStr] | None = None) -> str | None: ...
    def hashed_name(self, name: str, content: File[AnyStr] | None = None, filename: str | None = None) -> str: ...
    def url(self, name: str, force: bool = False) -> str: ...
    def url_converter(
        self, name: str, hashed_files: dict[str, Any], template: str | None = None
    ) -> Callable[[Match[str]], str]: ...
...
class ConfiguredStorage(LazyObject[Storage]): ...
