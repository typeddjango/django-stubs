import sys
from typing import (
    Any, Dict, Iterable, Iterator, List, Optional, Sequence, Tuple, Type, overload
)
...
class FileSystemFinder(BaseFinder):
    ...
    def find_location(self, root: _PathCompatible, path: str, prefix: Optional[str] = ...) -> Optional[_PathCompatible]: ...
