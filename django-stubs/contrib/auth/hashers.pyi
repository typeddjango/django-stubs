...
def verify_password(password: str | bytes | None, encoded: str, preferred: str = ...) -> tuple[bool, bool]: ...
def check_password(
    password: str | bytes | None, encoded: str, setter: Callable[[str], Any] | None = ..., preferred: str = ...
) -> bool: ...
async def acheck_password(
    password: str | bytes | None, encoded: str, setter: Callable[[str], Any] | None = ..., preferred: str = ...
) -> bool: ...
def make_password(password: str | bytes | None, salt: str | None = ..., hasher: str | BasePasswordHasher = ...) -> str: ...
