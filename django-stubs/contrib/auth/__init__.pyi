...
def authenticate(request: HttpRequest | None = ..., **credentials: Any) -> UserModel | None: ...
def login(request: HttpRequest, user: UserModel | None, backend: type[ModelBackend] | str | None = ...) -> None: ...
def logout(request: HttpRequest) -> None: ...
def get_user(request: HttpRequest | Client) -> UserModel | AnonymousUser: ...
def get_permission_codename(action: str, opts: Options) -> str: ...
def update_session_auth_hash(request: HttpRequest, user: UserModel) -> None: ...
