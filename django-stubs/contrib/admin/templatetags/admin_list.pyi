...
def items_for_result(cl: ChangeList, result: Model, form: ModelForm[Model] | None) -> Iterator[SafeString]: ...

class ResultList(list[Any]):
    form: ModelForm[Model] | None
    def __init__(self, form: ModelForm[Model] | None, *items: Any) -> None: ...
