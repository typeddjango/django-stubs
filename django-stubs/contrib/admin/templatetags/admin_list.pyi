...
def result_hidden_fields(cl: ChangeList) -> Iterator[BoundField[Any, Any]]: ...
def result_list(
    cl: ChangeList,
) -> dict[
    str, list[dict[str, int | str | None]] | list[ResultList] | list[BoundField[Any, Any]] | ChangeList | int
]: ...
