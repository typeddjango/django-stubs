...
class ManyToManyRawIdWidget(ForeignKeyRawIdWidget):
    ...
    def value_from_datadict(
        self, data: Mapping[str, Any], files: Mapping[str, Iterable[File[Any]]], name: str
    ) -> Any: ...
...
class RelatedFieldWidgetWrapper(forms.Widget):
    ...
    @property
    def choices(self) -> ModelChoiceIterator[Any]: ...
    @choices.setter
    def choices(self, value: ModelChoiceIterator[Any]) -> None: ...
