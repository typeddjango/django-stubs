...
class ManyToManyRawIdWidget(ForeignKeyRawIdWidget):
    ...
    def value_from_datadict(self, data: Mapping[str, Any], files: _FilesT[AnyStr], name: str) -> Any: ...
...
class RelatedFieldWidgetWrapper(forms.Widget):
    ...
    def get_context(self, name: str, value: Any, attrs: _OptAttrs | None) -> dict[str, Any]: ...
    def value_from_datadict(self, data: Mapping[str, Any], files: _FilesT[AnyStr], name: str) -> Any: ...
    def value_omitted_from_data(self, data: Mapping[str, Any], files: _FilesT[AnyStr], name: str) -> bool: ...
