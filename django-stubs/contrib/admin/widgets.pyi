...
class AutocompleteSelect(AutocompleteMixin, forms.Select): ...  # type: ignore[misc]
class AutocompleteSelectMultiple(AutocompleteMixin, forms.SelectMultiple): ...  # type: ignore[misc]
