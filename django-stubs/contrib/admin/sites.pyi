...
class AdminSite:
    ...
    def password_change(
        self, request: HttpRequest, extra_context: dict[_ContextKeys, Any] | None = ...
    ) -> TemplateResponse: ...
    ...
    def logout(self, request: HttpRequest, extra_context: dict[_ContextKeys, Any] | None = ...) -> TemplateResponse: ...
    def login(self, request: HttpRequest, extra_context: dict[_ContextKeys, Any] | None = ...) -> HttpResponse: ...
    ...
    def index(self, request: HttpRequest, extra_context: dict[_ContextKeys, Any] | None = ...) -> TemplateResponse: ...
    def app_index(
        self, request: HttpRequest, app_label: str, extra_context: dict[_ContextKeys, Any] | None = ...
    ) -> TemplateResponse: ...
