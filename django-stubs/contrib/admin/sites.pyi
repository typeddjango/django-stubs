...
class AdminSite:
    ...
    def logout(self, request: HttpRequest, extra_context: Mapping[_ContextKeys, Any] | None = ...) -> TemplateResponse: ...
    ...
    def index(self, request: HttpRequest, extra_context: Mapping[_ContextKeys, Any] | None = ...) -> TemplateResponse: ...
    def app_index(
