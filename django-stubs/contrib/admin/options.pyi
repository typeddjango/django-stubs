...
class ModelAdmin(BaseModelAdmin[_ModelT]):
    ...
    def render_delete_form(self, request: HttpRequest, context: dict[_ContextKeys, Any]) -> HttpResponse: ...
    ...
    def add_view(
        self, request: HttpRequest, form_url: str = ..., extra_context: dict[_ContextKeys, Any] | None = ...
    ) -> HttpResponse: ...
    def change_view(
        self,
        request: HttpRequest,
    ...
    def delete_view(
        self, request: HttpRequest, object_id: str, extra_context: dict[_ContextKeys, Any] | None = ...
    ) -> HttpResponse: ...
    def history_view(
        self, request: HttpRequest, object_id: str, extra_context: dict[_ContextKeys, Any] | None = ...
    ) -> HttpResponse: ...
