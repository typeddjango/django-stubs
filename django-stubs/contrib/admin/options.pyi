...
class BaseModelAdmin(Generic[_ModelT], metaclass=MediaDefiningClass):
    ...
    ) -> _ListOrTuple[type[InlineModelAdmin[Any, Any]]]: ...
    ...
    view_on_site: Callable[[_ModelT], str | None] | bool
    @property
...
class ModelAdmin(BaseModelAdmin[_ModelT]):
    ...
    inlines: ClassVar[_ListOrTuple[type[InlineModelAdmin[Any, Any]]]]
    ...
    def construct_change_message(
        self, request: HttpRequest, form: forms.Form, formsets: Iterable[BaseFormSet[Any]], add: bool = ...
...
class InlineModelAdmin(BaseModelAdmin[Any], Generic[_ChildModelT, _ParentModelT]):
    ...
    @override
    def get_view_on_site_url(self, obj: _ChildModelT | None = ...) -> str | None: ...
    view_on_site: Callable[[_ChildModelT], str | None] | bool
    @override
