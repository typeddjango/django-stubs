...
class BaseModelAdmin(Generic[_ModelT]):
    ...
    def get_field_queryset(
        self, db: str | None, db_field: RelatedField[Any, Any], request: HttpRequest
    ) -> QuerySet[Model] | None: ...
    ...
    def get_inlines(self, request: HttpRequest, obj: _ModelT | None) -> list[type[InlineModelAdmin[Model, Model]]]: ...
...
class ModelAdmin(BaseModelAdmin[_ModelT]):
    ...
    inlines: Sequence[type[InlineModelAdmin[Model, Model]]]
    ...
    ) -> list[InlineModelAdmin[Model, Model]]: ...
    ...
    ) -> type[BaseModelFormSet[_ModelT, ModelForm[Model]]]: ...
    ...
    def get_search_results(
        self, request: HttpRequest, queryset: QuerySet[Model], search_term: str
    ...
    def construct_change_message(
        ...
        formsets: Iterable[BaseFormSet[BaseForm]],
        add: bool = ...,
    ...
    def response_action(self, request: HttpRequest, queryset: QuerySet[Model]) -> HttpResponse | None: ...
...
class InlineModelAdmin(Generic[_ChildModelT, _ParentModelT], BaseModelAdmin[_ChildModelT]):
    ...
    fk_name: str | None
    formset: type[BaseInlineFormSet[_ChildModelT, _ParentModelT, forms.ModelForm[_ChildModelT]]]  # type: ignore[type-var]
    extra: int
    min_num: int | None
    max_num: int | None
    template: str
    ...
    ) -> type[BaseInlineFormSet[_ChildModelT, _ParentModelT, forms.ModelForm[_ChildModelT]]]: ...  # type: ignore[type-var]
