...
from typing import Any, Callable, Dict, Generic, Iterator, List, Optional, Sequence, Set, Tuple, Type, Union, Mapping, TypeVar
...
class BaseModelAdmin(Generic[_T]):
...
class ModelAdmin(BaseModelAdmin[_T]):
    ...
    def delete_model(self, request: HttpRequest, obj: _T) -> None: ...
