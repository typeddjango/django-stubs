...
class InlineModelAdmin(BaseModelAdmin[Any], Generic[_ChildModelT, _ParentModelT]):
    ...
    @override
    def has_view_or_change_permission(self, request: HttpRequest, obj: _ParentModelT | None = ...) -> bool: ...  # type: ignore[override]
    @override
    def get_view_on_site_url(self, obj: _ParentModelT | None = ...) -> str | None: ...
    @property
    @override
    def view_on_site(self) -> Callable[[_ParentModelT], str | None] | bool: ...  # type: ignore[override]
    @override
