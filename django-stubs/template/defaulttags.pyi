...
class ForNode(Node):
    ...
    nodelist_loop: Any = ...
    nodelist_empty: Any = ...
    def __init__(self, loopvars: List[str], sequence: FilterExpression, is_reversed: bool, nodelist_loop: NodeList, nodelist_empty: Optional[NodeList] = ...) -> None: ...
...
class IfEqualNode(Node):
    child_nodelists: Any = ...
    negate: Any = ...
    def __init__(self, var1: FilterExpression, var2: FilterExpression, nodelist_true: NodeList, nodelist_false: NodeList, negate: bool) -> None: ...
    def __repr__(self): ...
    def render(self, context: Context) -> SafeText: ...

class IfNode(Node):
    conditions_nodelists: Any = ...
    def __init__(self, conditions_nodelists: Union[List[Tuple[TemplateLiteral, NodeList]], List[Union[Tuple[TemplateLiteral, NodeList], Tuple[None, NodeList]]]]) -> None: ...
    def __repr__(self) -> str: ...
...
class RegroupNode(Node):
    ...
    def resolve_expression(self, obj: Dict[str, Union[str, int, date, List[str]]], context: Context) -> Union[int, str]: ...
    def render(self, context: Context) -> str: ...
...
class WithNode(Node):
    nodelist: Any = ...
    extra_context: Any = ...
    def __init__(self, var: None, name: None, nodelist: NodeList, extra_context: Dict[str, FilterExpression] = ...) -> None: ...
    def __repr__(self): ...
    def render(self, context: Context): ...
