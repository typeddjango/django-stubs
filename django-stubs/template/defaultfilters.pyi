...
def truncatechars(value: str, arg: Union[SafeString, int]) -> str: ...
...
def urlencode(value: str, safe: Optional[SafeString] = ...) -> str: ...
def urlize(value: str, autoescape: bool = ...) -> SafeString: ...
def urlizetrunc(value: str, limit: Union[SafeString, int], autoescape: bool = ...) -> SafeString: ...
def wordcount(value: str) -> int: ...
def wordwrap(value: str, arg: Union[SafeString, int]) -> str: ...
def ljust(value: str, arg: Union[SafeString, int]) -> str: ...
def rjust(value: str, arg: Union[SafeString, int]) -> str: ...
def center(value: str, arg: Union[SafeString, int]) -> str: ...
...
def length_is(value: Optional[Any], arg: Union[SafeString, int]) -> Union[bool, str]: ...
