...
from typing import Any, Callable, Generic, List, Sequence, Tuple, Type, TypeVar, overload
...
class classproperty(Generic[_Get]):
    fget: Callable[[_Self], _Get] | None
    def __init__(self, method: Callable[[_Self], _Get] | None = ...) -> None: ...
