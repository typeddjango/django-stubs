...
def date_format(value: date | builtin_datetime | str, format: str | None = None, use_l10n: bool | None = None) -> str: ...
def time_format(value: time | builtin_datetime | str, format: str | None = None, use_l10n: bool | None = None) -> str: ...
def number_format(
...
@overload
def localize_input(value: builtin_datetime | date | time | Decimal | float | str, default: str | None = None) -> str: ...
@overload
