...
from django.http.response import HttpResponse, HttpResponseBase, HttpResponseNotModified
...
def _not_modified(request: WSGIRequest, response: Optional[HttpResponse] = ...) -> HttpResponseNotModified: ...
def get_conditional_response(request: WSGIRequest, etag: Optional[str] = ..., last_modified: Optional[int] = ..., response: Optional[HttpResponse] = ...) -> Optional[HttpResponse]: ...
...
def patch_vary_headers(response: HttpResponseBase, newheaders: Union[Tuple[str, str], Tuple[str]]) -> None: ...
...
def _generate_cache_key(request: WSGIRequest, method: str, headerlist: List[str], key_prefix: str) -> str: ...
def _generate_cache_header_key(key_prefix: str, request: WSGIRequest) -> str: ...
def get_cache_key(request: WSGIRequest, key_prefix: Optional[str] = ..., method: str = ..., cache: Optional[Union[DefaultCacheProxy, backends.locmem.LocMemCache]] = ...) -> Optional[str]: ...
def learn_cache_key(request: WSGIRequest, response: HttpResponse, cache_timeout: Optional[float] = ..., key_prefix: Optional[str] = ..., cache: Optional[Union[DefaultCacheProxy, backends.locmem.LocMemCache]] = ...) -> str: ...
