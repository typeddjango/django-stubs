...
def _not_modified(
    request: WSGIRequest, response: Optional[HttpResponse] = ...
...
def _if_modified_since_passes(
    last_modified: Optional[int], if_modified_since: int
) -> bool: ...
...
def patch_vary_headers(
    response: HttpResponseBase, newheaders: Union[Tuple[str, str], Tuple[str]]
) -> None: ...
...
def _generate_cache_key(
    request: WSGIRequest, method: str, headerlist: List[str], key_prefix: str
) -> str: ...
