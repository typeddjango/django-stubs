...
class classonlymethod(classmethod):
    def __get__(
        self, instance: None, cls: Type[Union[View, PermissionRequiredMixin]] = ...
    ) -> Callable: ...

def _update_method_wrapper(_wrapper: Callable, decorator: Callable) -> None: ...
def _multi_decorate(
    decorators: Union[Tuple[Callable, Callable], Callable], method: Callable
) -> Callable: ...
...
class classproperty:
    ...
    def __get__(
        self, instance: Optional[LiveServerTestCase], cls: Type[LiveServerTestCase] = ...
    ) -> str: ...
