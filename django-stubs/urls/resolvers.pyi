...
class ResolverMatch:
    ...
    _func_path: Any = ...
    view_name: Any = ...
    def __init__(self, func: Callable, args: Tuple, kwargs: Dict[str, Any], url_name: Optional[str] = ..., app_names: Optional[Union[List[None], List[str], List[Union[None, str]]]] = ..., namespaces: Optional[Union[List[None], List[str], List[Union[None, str]]]] = ...) -> None: ...
...
class URLPattern:
    ...
    default_args: Any = ...
    name: Any = ...
    def __init__(self, pattern: CheckURLMixin, callback: Callable, default_args: Any = ..., name: Optional[str] = ...) -> None: ...
    def __repr__(self) -> str: ...
    def check(self) -> List[Warning]: ...
...
class URLResolver:
    ...
    _populated: bool = ...
    _local: Any = ...
    def __init__(self, pattern: Union[LocalePrefixPattern, CheckURLMixin], urlconf_name: Any, default_kwargs: None = ..., app_name: Optional[str] = ..., namespace: Optional[str] = ...) -> None: ...
    def __repr__(self) -> str: ...
    ...
    def url_patterns(self) -> Union[List[Union[URLPattern, URLResolver]], List[URLResolver], List[Tuple[str, Callable]], List[URLPattern]]: ...
    ...
    def _reverse_with_prefix(self, lookup_view: Optional[str], _prefix: str, *args: Any, **kwargs: Any) -> str: ...
