...
def get_resolver(urlconf: str | None = None) -> URLResolver: ...
def get_ns_resolver(ns_pattern: str, resolver: URLResolver, converters: tuple[Any, ...]) -> URLResolver: ...

_Pattern: TypeAlias = RegexPattern | RoutePattern | LocalePrefixPattern

class LocaleRegexDescriptor:
    @overload
    def __get__(self, instance: None, cls: type[_Pattern] | None = None) -> LocaleRegexDescriptor: ...
    @overload
    def __get__(self, instance: _Pattern, cls: type[_Pattern] | None = None) -> Pattern[str]: ...
...
class RegexPattern(CheckURLMixin):
    ...
    def __init__(self, regex: str, name: str | None = None, is_endpoint: bool = False) -> None: ...
    def match(self, path: str) -> tuple[str, tuple[Any, ...], dict[str, str]] | None: ...
...
class RoutePattern(CheckURLMixin):
    ...
    def match(self, path: str) -> tuple[str, tuple[Any, ...], dict[str, int | str]] | None: ...
    def check(self) -> list[CheckMessage]: ...
