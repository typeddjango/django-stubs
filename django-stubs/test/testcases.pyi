...
class SimpleTestCase(unittest.TestCase):
    ...
    def _assert_contains(self, response: HttpResponseBase, text: Union[str, bytes, int], status_code: int, msg_prefix: str, html: bool) -> Tuple[str, int, str]: ...
    ...
    def _assert_template_used(self, response: Optional[Union[str, HttpResponse]], template_name: Optional[str], msg_prefix: str) -> Union[Tuple[None, List[Any], str], Tuple[str, None, str], Tuple[None, List[str], str]]: ...
    ...
    def _assert_raises_or_warns_cm(self, func: Callable, cm_attr: str, expected_exception: Type[Exception], expected_message: str) -> Iterator[Union[_AssertRaisesContext, _AssertWarnsContext]]: ...
    def _assertFooMessage(self, func: Callable, cm_attr: str, expected_exception: Type[Exception], expected_message: str, *args: Any, **kwargs: Any) -> _GeneratorContextManager: ...
...
class LiveServerThread(threading.Thread):
    ...
    def __init__(self, host: str, static_handler: Type[_StaticFilesHandler], connections_override: Dict[str, DatabaseWrapper] = ..., port: int = ...) -> None: ...
    httpd: Any = ...
    def run(self) -> None: ...
...
class LiveServerTestCase(TransactionTestCase):
    ...
    def setUpClass(cls) -> None: ...
    @classmethod
    def _create_server_thread(cls, connections_override: Dict[str, DatabaseWrapper]) -> LiveServerThread: ...
    @classmethod
