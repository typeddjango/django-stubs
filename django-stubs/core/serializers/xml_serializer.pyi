...
class Serializer(base.Serializer):
    ...
    def _start_relational_field(self, field: Union[ManyToManyField, ForeignKey]) -> None: ...

class Deserializer(base.Deserializer):
    event_stream: Any = ...
    db: Any = ...
    ignore: Any = ...
    def __init__(self, stream_or_string: Union[str, TextIOWrapper, BufferedReader], *, using: Any = ..., ignorenonexistent: bool = ..., **options: Any) -> None: ...
    ...
    def _handle_m2m_field_node(self, node: Element, field: ManyToManyField) -> List[int]: ...
...
class DefusedExpatParser(_ExpatParser):
    ...
    def entity_decl(self, name: Any, is_parameter_entity: Any, value: Any, base: Any, sysid: Any, pubid: Any, notation_name: Any) -> None: ...
