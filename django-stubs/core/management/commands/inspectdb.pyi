...
class Command(BaseCommand):
    ...
    db_module: str = ...
    def handle_inspection(self, options: Any) -> Iterable[str]: ...
    def normalize_col_name(self, col_name: str, used_column_names: Any, is_relation: Any) -> Tuple[str, Dict[str, str], List[str]]: ...
