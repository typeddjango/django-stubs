...
@type_check_only
class RedisCacheClientSerializer(Protocol):
...
class RedisCacheClient:
    def __init__(
        self,
        servers: list[str],
        serializer: str | Callable[[], RedisCacheClientSerializer] | RedisCacheClientSerializer | None = ...,
        pool_class: str | type[ConnectionPool] | None = ...,
        parser_class: str | type[BaseParser] | None = ...,
        **options: Any,
    ) -> None: ...
    def get_client(self, key: Unused = ..., *, write: bool = ...) -> Redis: ...
    def add(self, key: _Key, value: Any, timeout: _Expiry | None): ...
    def get(self, key: _Key, default: Any) -> Any: ...
    def set(self, key: _Key, value: Any, timeout: _Expiry | None): ...
