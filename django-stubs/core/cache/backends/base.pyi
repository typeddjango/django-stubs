...
class BaseCache:
    ...
    def add(self, key: Any, value: Any, timeout: Any = ..., version: Optional[int] = ...) -> bool: ...
    def get(self, key: Any, default: Optional[Any] = ..., version: Optional[int] = ...) -> Any: ...
    def set(self, key: Any, value: Any, timeout: Any = ..., version: Optional[int] = ...) -> None: ...
    def touch(self, key: Any, timeout: Any = ..., version: Optional[int] = ...) -> bool: ...
    ...
    def set_many(self, data: Dict[Any, Any], timeout: Any = ..., version: Optional[int] = ...) -> List[Any]: ...
