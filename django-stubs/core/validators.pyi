...
class RegexValidator:
    ...
    inverse_match: bool = ...
    flags: int = ...
    def __init__(self, regex: Optional[str] = ..., message: Optional[str] = ..., code: Optional[str] = ..., inverse_match: Optional[bool] = ..., flags: Optional[RegexFlag] = ...) -> None: ...
...
class BaseValidator:
    ...
    code: str = ...
    limit_value: Any = ...
    def __init__(self, limit_value: Optional[Union[Decimal, float, datetime]], message: None = ...) -> None: ...
    def __call__(self, value: Union[Decimal, float, str, datetime]) -> None: ...
    def __eq__(self, other: Any): ...
    def compare(self, a: bool, b: bool) -> bool: ...
    def clean(self, x: Union[Decimal, datetime, float]) -> Union[Decimal, datetime, float]: ...
...
class MinValueValidator(BaseValidator):
    message: Any = ...
    code: str = ...
    def compare(self, a: Union[float, Decimal, datetime], b: Union[float, Decimal, datetime]) -> bool: ...
...
class FileExtensionValidator:
    ...
    def __init__(self, allowed_extensions: Optional[List[str]] = ..., message: Optional[str] = ..., code: Optional[str] = ...) -> None: ...
