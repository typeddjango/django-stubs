...
class EmailMessage:
    ...
    @overload
    def attach(self, filename: None = None, content: _AttachmentContent | None = None, mimetype: str | None = None) -> None: ...
    @overload
    def attach(self, filename: str | None = None, content: _AttachmentContent | None = None, mimetype: str | None = None) -> None: ...
