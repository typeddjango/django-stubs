...
class EmailMessage:
    ...
    @overload
    def attach(self, filename: MIMEBase = None, content: None = None, mimetype: None = None) -> None: ...
    @overload
    def attach(self, filename: None = None, content: _AttachmentContent = None, mimetype: str = None) -> None: ...
    @overload
    def attach(self, filename: str = None, content: _AttachmentContent = None, mimetype: str | None = None) -> None: ...
