...
class BaseCache:
    ...
    def get_backend_timeout(self, timeout: int = ...) -> Optional[float]: ...
    def make_key(self, key: str, version: Optional[int] = ...) -> str: ...
    def add(
        self, key: str, value: Any, timeout: int = ..., version: Optional[int] = ...
    ) -> bool: ...
    def get(
    ...
    def touch(
        self, key: str, timeout: int = ..., version: Optional[int] = ...
    ) -> bool: ...
    ...
    def set_many(
        self, data: Dict[str, Any], timeout: int = ..., version: Optional[int] = ...
    ) -> List[Any]: ...
    def delete_many(
