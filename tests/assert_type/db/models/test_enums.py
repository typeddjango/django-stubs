...
def get_choices_using_property(choices: type[T_Choices]) -> list[tuple[int, str]]:
    return choices.choices  # pyright: ignore[reportReturnType]  # ty: ignore[invalid-return-type]


def get_labels_using_property(choices: type[T_Choices]) -> list[str]:
    return choices.labels  # pyright: ignore[reportReturnType]  # ty: ignore[invalid-return-type]
...
assert_type(Suit.labels, list[_StrPromise])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(Suit.values, list[int])
assert_type(Suit.choices, list[tuple[int, _StrPromise]])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
...
assert_type(YearInSchool.labels, list[_StrPromise])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(YearInSchool.values, list[str])
assert_type(YearInSchool.choices, list[tuple[str, _StrPromise]])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
...
assert_type(Vehicle.values, list[int | None])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
...
assert_type(Gender.labels, list[str])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(Gender.values, list[str | None])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(Gender.choices, list[tuple[str | None, str]])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
...
assert_type(Medal.labels, list[str])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(Medal.values, list[str])
assert_type(Medal.choices, list[tuple[str, str]])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
...
assert_type(Separator.labels, list[str])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(Separator.values, list[bytes])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(Separator.choices, list[tuple[bytes, str]])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(Separator.FS, Literal[Separator.FS])
assert_type(Separator.FS.name, Literal["FS"])
assert_type(Separator.FS.label, str)  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(Separator.FS.value, bytes)  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
...
assert_type(Constants.labels, list[str])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(Constants.values, list[float | None])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(Constants.choices, list[tuple[float | None, str]])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
...
assert_type(VoidChoices.labels, list[str])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]

assert_type(VoidChoices.values, list[int | None])  # type: ignore[assert-type]  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(VoidChoices.values, list[Any | None])  # pyright: ignore[reportAssertTypeFailure]  # pyrefly: ignore[assert-type]  # ty: ignore[type-assertion-failure]

assert_type(VoidChoices.choices, list[tuple[int | None, str]])  # type: ignore[assert-type]  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(VoidChoices.choices, list[tuple[Any | None, str]])  # pyright: ignore[reportAssertTypeFailure]  # pyrefly: ignore[assert-type]  # ty: ignore[type-assertion-failure]
...
assert_type(imported.Direction.labels, list[str])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(imported.Direction.values, list[str])
assert_type(imported.Direction.choices, list[tuple[str, str]])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
...
assert_type(CompassPoint.labels, list[str])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(CompassPoint.values, list[str])
assert_type(CompassPoint.choices, list[tuple[str, str]])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
...
assert_type(Award.labels, list[str])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(Award.values, list[str])
assert_type(Award.choices, list[tuple[str, str]])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
...
assert_type(DeckModel.House.choices, list[tuple[int, _StrPromise]])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
assert_type(DeckModel.Joker.choices, list[tuple[str, str]])  # pyright: ignore[reportAssertTypeFailure]  # ty: ignore[type-assertion-failure]
