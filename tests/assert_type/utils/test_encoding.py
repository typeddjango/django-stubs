...
def test_force_str() -> None:
    ...
    assert_type(force_str(dt.datetime.now(dt.UTC), strings_only=True), dt.datetime)
...
def test_smart_bytes() -> None:
    ...
    assert_type(smart_bytes(dt.datetime.now(dt.UTC), strings_only=True), dt.datetime)
...
def test_smart_str() -> None:
    ...
    assert_type(smart_str(dt.datetime.now(dt.UTC), strings_only=True), dt.datetime)
